          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
             <div className="space-y-10">
                ...
                <div className="space-y-8">
                    <div className="flex items-start gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500">NexDent klinikasi. Toshkent sh., Chilonzor tumani, Lutfiy ko'chasi, 24-uy</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex gap-4">
                    ...
                    <Button variant="outline" className="rounded-2xl h-14 px-6 border-slate-200" asChild>
                        <a href="https://instagram.com/temur0708" target="_blank" rel="noopener noreferrer">Instagram</a>
                    </Button>
                </div>
             </div>
             <a 
                href="https://www.google.com/maps?q=41.549579,60.605297" 
                target="_blank" 
         ...
         <div className="max-w-7xl mx-auto grid lg:grid-cols-4 gap-12 border-b border-white/10 pb-20">
            <div className="col-span-2 space-y-6">
                 <div className="flex items-center gap-2">
                    <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center text-primary font-black">ND</div>
            ...
            <div className="space-y-6">
                ...
                <ul className="space-y-4 text-white/50 font-medium">
                    <li><a href="https://instagram.com/temur0708" className="hover:text-white" target="_blank" rel="noopener noreferrer">Instagram</a></li>
